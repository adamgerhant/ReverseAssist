  ...
  return (
    <div className={`flex flex-${isMobile?"col":"row"} h-[100vh] relative`}>
      ...
      <div className={`flex flex-col ${isMobile?"pb-2":"w-[480px] h-[100%]"}  items-center bg-fuchsia-800`}>
          ...
          {false&&isMobile&&selectExpanded&&<div onClick={()=>setSelectExpanded(false)}className='flex flex-col items-center mb-1  text-[#444] font-semibold bg-[rgba(255,255,255,1)] w-[160px] border-t border-[#555] rounded-b'>
            <div className='flex flex-row'>
              <BsChevronUp className='mt-[4px] ml-2 h-[16px] w-[16px]'/>
            </div>
          </div>}
          {false&&isMobile&&!selectExpanded&&<div onClick={()=>setSelectExpanded(true)}className='flex flex-col items-center mb-1  text-[#444] font-semibold bg-[rgba(255,255,255,1)] w-[160px] border-t border-[#555] rounded-b'>
            <div className='flex flex-row'>
