...
const About = () =>{
    return(
        <div className='w-[900px] rounded-lg shadow-[0_0_50px_10px_rgba(0,0,0,0.4)] h-[70%] absolute z-3 bg-white overflow-hidden'>
            <div className='flex flex-col items-center'>
                    <div className='bg-fuchsia-800 w-full flex flex-row'>
                        ...
                        <div className='text-4xl text-white font-semibold ml-[35%] mt-3 mb-4'>
                            About
                        </div>
                    </div>
